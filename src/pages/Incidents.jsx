          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1fr_1fr_280px] gap-6">
            ...
            <section className="bg-white/90 rounded-xl shadow-md border border-slate-100 p-4 flex flex-col order-1 md:order-1">
              ...
              <div className="flex flex-col gap-3 overflow-y-auto max-h-[50vh] md:max-h-[62vh] pr-1">
                {alerts.map(a => (
                  <div key={a.id} className="flex gap-3 p-3 rounded-lg bg-gradient-to-b from-white to-blue-50 border border-slate-100 items-start">
            ...
            <aside className="bg-white/90 rounded-xl shadow-md border border-slate-100 p-4 flex flex-col gap-4 order-3 md:order-3">
              <div className="grid grid-cols-1 sm:grid-cols-1 gap-3">
                ...
                <div className="p-3 rounded-lg bg-gradient-to-b from-white to-blue-50 shadow">
                  <div className="text-gray-500 font-semibold text-xs sm:text-sm mb-2">Incident Map</div>
                  <div className="w-full h-32 sm:h-40 rounded-lg bg-blue-50 border border-dashed border-blue-200 flex items-center justify-center text-gray-400 font-bold mb-2">Map placeholder</div>
                  <div className="flex flex-wrap gap-3 mt-2 text-xs sm:text-sm">
                    <div className="flex items-center gap-2 text-blue-700"><span className="w-3 h-3 rounded bg-blue-600 inline-block"></span> Theft</div>
                    <div className="flex items-center gap-2 text-orange-600"><span className="w-3 h-3 rounded bg-orange-500 inline-block"></span> Injury</div>
                    <div className="flex items-center gap-2 text-red-600"><span className="w-3 h-3 rounded bg-red-500 inline-block"></span> Medical</div>
                    <div className="flex items-center gap-2 text-green-600"><span className="w-3 h-3 rounded bg-green-600 inline-block"></span> Missing</div>
                  </div>
                </div>
              </div>
            </aside>
